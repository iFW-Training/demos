...
function ran.PV1(PV1)
   local Doctor = ran.choose(ran.doctor) 
   PV1[8][1][2][1] = Doctor.surname
   PV1[8][1][3] = Doctor.givenname
   PV1[8][1][6] = Doctor.prefix
...
ran.doctor = {
   {  surname="Komorov", givenname="Leo",     prefix="DR"   },
   {  surname="Lupul",   givenname="Amy",     prefix="DR"   },
   {  surname="Kessel",  givenname="Phil",    prefix="DR"   },
   {  surname="Gardiner",givenname="Jenny",   prefix="DR"   },
   {  surname="Reilly",  givenname="Morgan",  prefix="DR"   }
}
